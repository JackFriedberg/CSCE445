        ...
        <?php
            if($context){
                ...
                while($row = sqlsrv_fetch_array($context)){
                    ...
                    echo '
                        <button type="button" class="btn btn-info btn-lg button-width .navbar-right active" data-toggle="modal" data-target="#contextModal">Click for context # ' . strval($counter) . '</button>
