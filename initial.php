        ...
        <?php
            if($context){
                ...
                while($row = sqlsrv_fetch_array($context)){
                    ...
                    echo '
                        <button type="button" class="btn btn-primary btn-floating col-md-4 center-block" data-toggle="modal" data-target="#contextModal">Click for context # ' . strval($counter) . '</button>
